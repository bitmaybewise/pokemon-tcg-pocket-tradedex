...
export function ProfileProvider({ children }: { children: React.ReactNode }) {
  ...
  const getProfileByFriendId = async (friendId: string): Promise<UserProfile | null> => {
    try {
  ...
  return (
    <ProfileContext.Provider value={{ profile, loading, updateProfile, getProfileByFriendId }}>
      {children}
