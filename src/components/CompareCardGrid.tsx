...
export default function CompareCardGrid({ left, right, user1Name, user2Name }: CompareCardGridProps) {
          ...
          <div className={styles.compareColumn}>
            <div className={styles.cardGrid}>
              {(left[rarity] || []).map(card => (
                <div key={card.id} className={`nes-container with-title is-centered ${styles.card}`}>
